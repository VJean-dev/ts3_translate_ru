...
<table id="info">
  <tr title="Порядок канала: %%CHANNEL_ORDER%%">
  ...
  <tr>
    ...
    <td>%%CHANNEL_CODEC_QUALITY%% (битрейт: %%CHANNEL_CODEC_BITRATE%%/s)</td>
  </tr>
  ...
  <tr><td class="label">Модерируемый:</td><td class="red"><img src="iconpath:MODERATED?size=16x16" height="12" width="12" alt="" title="Request Talk Power to be able to talk in this Channel." />&nbsp;&nbsp;%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr>
  <tr>
    <td class="label">Подписка:</td>
...
<p style="margin-top: 4px; color:darkRed;">Канал будет удален через: %%?TEMP_CHANNEL_TIME_TO_DELETE%%.</p>

<table id="list" width=100%>
  <tr><td class="space label"><img src="iconpath:CHANGE_NICKNAME?size=16x16" height="12" width="12" alt=""> Описание:</td></tr><tr><td class="list">%%?CHANNEL_DESCRIPTION%%</td></tr>
</table>
