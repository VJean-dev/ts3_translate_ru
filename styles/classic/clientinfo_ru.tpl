...
<table id="info">
  <tr>
    ...
    <td>
      ...
      <span class="blue" title="Желаемый никнейм">[%%?CLIENT_CUSTOM_NICK_NAME%%]</span>
    </td>
  </tr>
  ...
  <tr title="%%CLIENT_VERSION%%">
    ...
    <td>%%CLIENT_VERSION_SHORT%% %%CLIENT_VERSION_STATE%% на %%CLIENT_PLATFORM%%</td>
  </tr>
  <tr title="Первое подключение: %%CLIENT_CREATED%%, Всего подключений: %%CLIENT_TOTALCONNECTIONS%%">
    <td class="label">Онлайн:</td>
    <td>%%CLIENT_CONNECTED_SINCE%%</td>
  </tr>
</table>

<table id="list">
  <tr><td class="space label"><img src="iconpath:PERMISSIONS_SERVER_GROUPS?size=16x16" height="12" width="12" alt=""> Группы сервера:</td></tr>
  <tr><td class="list">
    <div>%%CLIENT_SERVER_GROUP_ICON%% %%CLIENT_SERVER_GROUP_NAME%%</div>
  </td></tr>
  <tr><td class="space label"><img src="iconpath:PERMISSIONS_CHANNEL_GROUPS?size=16x16" height="12" width="12" alt=""> Группы канала:</td></tr>
  <tr><td class="list">
